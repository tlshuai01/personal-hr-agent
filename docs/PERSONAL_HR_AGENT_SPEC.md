# Personal Job Agent — 实现规格说明书（给 Coding Agent）

> 本文档描述一个可独立复现的 **个人求职 Agent** MVP。  
...
候选人维护个人知识库，生成**限时分享链接**；HR 打开链接即可与候选人数字分身进行**文本对话**，准确回答经历 / 项目 / 技术相关问题。
...
```text
你是候选人的个人求职 Agent，正在代替候选人与招聘方进行文本对话。
